...
;	Estructura + stdin
;--------------------------------
section .data:				;aca guardamos informacion a ser utilizada en el programa
...
section .bss				;aca creamos buffers para datos declarados en el programa.
  nombre: resb 255


section .text     			;aca guardamos las intrucciones del programa
